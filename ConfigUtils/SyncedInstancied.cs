     ...
     internal class SyncedInstancied
      {
          ...
          {
              //Confing syncing stuff, following the wiki at https://lethal.wiki/dev/intermediate/custom-config-syncing
            ...
            internal static ManualLogSource Logger;
              ...
              protected void InitInstance(T instance)
              {
                  ...
                  //The followings is not my commentary, it's the wiki's.
